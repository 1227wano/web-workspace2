      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          -->
          				...
          				<!-- ↓ empty를 eq null 대신 쓰는 이유 : empty는 null인지도 보고 빈 문자열인지도 보니까 -->
          <c:choose>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- 
				...
				form태그 안에 존재하는 submit버튼을 클릭했을 때
				fotm태그의 action속성에 작성된 URL로 요청(제출)
				
				==> Controller(Servlet)을 호출
				
				*경로 지정 방식
				절대 경로 방식(/) : /contextroot/요청할 URL
								 TOMCAT 포트 뒤 localhost:80 뒤에 action에 작성한 값이 붙으면서 요청
				
				상대 경로 방식(매핑값) : / 없이 시작하는 경우
									현재 이 페이지에 보여지는 URL경로 중에
